        ...
        \subsection{The $p$-value}
            ...
            \subsubsection{Theorem}
                ...
                \paragraph{Proof}
                    ...
                    This final equality holds as the supremum
                    $\sup\limits_{\theta \in \Omega_0} \bb{P}(T \geq c |
                    \theta)$ is a decreasing function of $c$, so we should take
                    $c$ to be as large as possible to minimise this.
